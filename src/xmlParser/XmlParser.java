...
public class XmlParser {
	 ...
	 */
	 public static XmlNode loadXmlFile(String filePath) {
	        ...
	        try {
	            reader = new BufferedReader(new FileReader(filePath));  // Open file using FileReader
	        } catch (IOException e) {
	            e.printStackTrace();
	        ...
	        try {
	            reader.readLine(); // Read the first line (this could be an XML declaration, for example)
