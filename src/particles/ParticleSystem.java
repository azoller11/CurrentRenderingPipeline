...
public class ParticleSystem {
	...
	public float pps, averageSpeed, gravityComplient, averageLifeLength, averageScale;
	...
	private void emitParticle(Vector3f center) {
		...
		new Particle(texture, new Vector3f(center), velocity, gravityComplient, lifeLength, generateRotation(), this.averageScale);
	}
